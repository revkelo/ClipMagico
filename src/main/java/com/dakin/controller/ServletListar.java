...
public class ServletListar extends HttpServlet {
	...
	/**
	 * M�todo que maneja la petici�n GET y muestra la informaci�n de los aspirantes
	 * en una tabla HTML por carrera.
	 * 
	 * @param req  objeto HttpServletRequest que contiene la informaci�n de la
	 *             solicitud del cliente.
	 * 
	 * @param resp objeto HttpServletResponse que contiene la informaci�n de la
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (mostrar.equals("cliente")) {
			...
			ArrayList<ClienteDTO> listaClientes = cli.mostrarClientes(); // M�todo para obtener clientes de la base de
																			// datos
			...
			salida.println("<th>Direcci�n</th>");
			salida.println("<th>Tel�fono</th>");
			salida.println("</tr>");
			salida.println("</thead>");
			...
			ArrayList<ProveedorDTO> listaProveedores = proveedor1.mostrarProveedores(); // M�todo para obtener
			...
			ArrayList<VentaDTO> listaVentas = ven.mostrarVentas(); // M�todo para obtener ventas de la base de datos
			...
			salida.println("<th>M�todo de Pago</th>");
			...
			ArrayList<Productos_ventaDTO> listaProductosv = pv.mostrarProductoVenta(); // M�todo para obtener productos
																			// de la base de datos
			...
			ArrayList<ProductoDTO> listaProductos = pro.mostrarProductos(); // M�todo para obtener productos
																			// de la base de datos
			...
			salida.println("<th>ID Producto</th>");
			salida.println("<th>Nombre</th>");
			salida.println("<th>Descripci�n</th>");
			salida.println("<th>ID Proveedor</th>");
			salida.println("<th>Cantidad</th>");
			...
			for (ProductoDTO producto : listaProductos) {
				...
				if (producto.getCantidad() <= 10) {
			        salida.println("<script>alert('El producto con ID " + producto.getIdProducto() + " está por agotarse.')</script>");
			        System.out.println("El producto con ID " + producto.getIdProducto() + " está por agotarse.");
			    }
			}
			...
			salida.close();
				...
				ArrayList<FacturaDTO> listafactura = fa.mostrarFacturas(); // M�todo para obtener productos
																				// de la base de datos
	...
	/**
	 * 
	 * M�todo que se ejecuta al enviar el formulario con m�todo POST.
	 * 
	 * Recibe un objeto HttpServletRequest con la informaci�n de la solicitud HTTP
	 * 
	 * y un objeto HttpServletResponse con la informaci�n de la respuesta HTTP.
	 * 
	 * @param req  objeto HttpServletRequest con la informaci�n de la solicitud
	 *             HTTP.
	 * 
	 * @param resp objeto HttpServletResponse con la informaci�n de la respuesta
	 *             HTTP.
	 * 
	 * @throws ServletException si ocurre un error en la ejecuci�n del servlet.
	 * 
